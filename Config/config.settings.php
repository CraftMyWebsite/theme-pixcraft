...
return [
   /* - - - - - - - - 
    ...
    "header_show_members" => "1",
    "header_show_online" => "1",
    "header_img_logo" => "Config/Default/logo.png",
    ...
    "main_color" => "#A32E34",
    "title_color" => "#ffffff",
    "nav_text_color" => "#262626",
    "nav_hover_text_color" => "#ffffff",
    "nav_player_name_color" => "#363232",
    "nav_player_name_background" => "#c4c4c4",
    "nav_background" => "#f3f3f3",
    "website_font" => "roboto",
    "website_secondary_font" => "paytone",
    "head_text_color" => "#ffffff",
    "head_background_color" => "#363232",
    "header_alert" => "0",
    "header_alert_text" => "PixCraft est vraiment un super thème <3",
    "header_alert_color" => "#cbe722",
    "header_alert_duration" => "0.5",
    ...
    "home_use_slider" => "1",
    "use_slide_1" => "1",
    "slider_img_1" => "Config/Default/bg-1.jpg",
    "slider_title_1" => "Bienvenue",
    "slider_text_1" => "Découvrez PixCraft dès maintenant !",
    "use_slide_2" => "1",
    "slider_img_2" => "Config/Default/bg-2.jpg",
    "slider_title_2" => "Explorez le Monde",
    "slider_text_2" => "Partez à la découverte, où chaque coin du monde révèle un trésor caché.",
    "use_slide_3" => "1",
    "slider_img_3" => "Config/Default/bg-3.jpg",
    "slider_title_3" => "Harmonie",
    "slider_text_3" => "Bâtissez votre monde en harmonie, bloc par bloc, aventure après aventure.",
    "use_slide_4" => "1",
    "slider_img_4" => "Config/Default/bg-4.jpg",
    "slider_title_4" => "Design et Créativité",
    "slider_text_4" => "Concevez, créez, et partagez : un monde où chaque bloc est une idée.",
    "use_slide_5" => "1",
    "slider_img_5" => "Config/Default/bg-5.jpg",
    "slider_title_5" => "Hier, Aujourd'hui, Demain",
    "slider_text_5" => "De pierre en pixel, façonnez hier, explorez aujourd'hui, rêvez demain.",
    /*FEATURE SECTION*/
    "feature_section_active" => "1",
    "feature_section_title" => "Fonctionnalités",
    "feature_img_1" => "Config/Default/feature1.webp",
    "feature_title_1" => "Communauté",
    "feature_description_1" => "Amet minim mollit non deserunt ullamco est sit aliqua",
    "feature_img_2" => "Config/Default/feature2.webp",
    "feature_title_2" => "Savoir faire",
    "feature_description_2" => "Amet minim mollit non deserunt ullamco est sit aliqua",
    "feature_img_3" => "Config/Default/feature3.webp",
    "feature_title_3" => "Réactif",
    "feature_description_3" => "Amet minim mollit non deserunt ullamco est sit aliqua",
    /*JOIN SECTION*/
    "join_section_active" => "1",
    "join_ip" => "play.pixcraft.fr",
