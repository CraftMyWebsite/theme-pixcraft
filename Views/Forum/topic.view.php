    ...
    <div class="mx-auto">
        <div class="flex justify-center">
            <?php if ($currentPage !== "1"): ?>
                <a href="p1" style="background-color: var(--bg-pixcraft); color: var(--nav-color-pixcraft-hover)"
                ...
                <a href="p<?=$currentPage-1?>" style="background-color: var(--bg-pixcraft); color: var(--nav-color-pixcraft-hover)"
            ...
            <?php if ($currentPage !== $totalPage): ?>
                ...
                <a href="p<?=$totalPage?>" style="background-color: var(--bg-pixcraft); color: var(--nav-color-pixcraft-hover)"
